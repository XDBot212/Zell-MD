...
try {
    ...
    if (!args[1]) return conn.sendButton(m.chat, `*${htki} Facebook Downloader ${htka}*\n\nSilahkan Pilih Resolusi Video Dibawah`, null, null, [['SD', `.fb ${args[0]} sd`],['HD', `.fb ${args[0]} hd`]],m)
...
conn.reply(m.chat, `${global.wait}`, 0, {
...
━━━━━•─────────────── ${duration}
       ⇆ㅤ◁ㅤ ❚❚ㅤ ▷ㅤ↻`, await (await fetch(url)).buffer(), args[0], '🔗 U R L', null,null, [[null,null],[null,null],[null,null]],m)
       } catch {
...
//handler.level = 30 //use it if you want
