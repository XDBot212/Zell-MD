...
let handler = async (m, { conn, isRowner}) => {
  ...
  let speed = neww - old
  await conn.reply(m.chat,`- *P i n g* -
...
• *${groupsIn.length - groupsIn.length}* Group Left
• *${chats.length - groupsIn.length}* Personal Chat
...
handler.command = /^(ping|speed|info|zellspeed)$/i
