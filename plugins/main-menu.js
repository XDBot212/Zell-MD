...
let withh = moment.tz('Asia/Jayapura').format('HH')
...
let wktuwit = `${withh} H ${witm} M ${wits} S`
...
┢╶╶╶╶╶╶╶╶╶╶╶╶╶╶╶╶╶╶╶╼
┣╌ ⟪ *U S E R  I N F O* ⟫
┃${z} *Name* : ${usrs.registered ? usrs.name : conn.getName(m.sender)}
┃${z} *Status* : ${m.sender.split`@`[0] == nomorown ? 'Developer' : (usrs.premiumTime >= 1 ? 'Premium User' : 'Free User')}
┃${z} *Premium* : ${usrs.premiumTime > 1 ? '✔ Yes': '✘ No'}
┃${z} *Role* : ${usrs.role}
┃${z} *Limit* : ${usrs.limit}
┃${z} *Level* : ${usrs.limit}
╰╴╴╴${emot}
...
▢ ▱▱▱▱▱▱▱▱▱▱▱▱ ▢  
`
let fot = `[❗] Note: If you find a bug/error feature, you can report it by typing »» .report [complaint]`
const listMessage = {
text: tett,
footer: fot,
...
let zell = `./mp3/unconditionalzell.opus`
await conn.sendFile(m.chat, audio, 'zell.mp3', null, m, true, {
type: 'audioMessage', 
ptt: false, seconds: 0,contextInfo: {
 ...
 mediaUrl: sgc,
    mediaType: 2, 
    description: sgc,
    title: "18 - One Direction | Click to Join Zell Group",
    body: wm,
 ...
 await conn.sendFile(m.chat, zell, 'tzell.mp3', null, m, true, {
type: 'audioMessage', 
ptt: false, seconds: 0,contextInfo: {
         externalAdReply: { showAdAttribution: true,
 mediaUrl: sgc,
    mediaType: 2, 
    description: sgc,
    title: "Unconditional - Katy Pery | Click to Join Zell Group",
    body: wm,
    thumbnail: await (await fetch('https://telegra.ph/file/c6454099b73f09954c6fb.jpg')).buffer(),
    sourceUrl: sgc
}
...
┃${z} *Name* : ${usrs.registered ? usrs.name : conn.getName(m.sender)}
┃${z} *Status* : ${m.sender.split`@`[0] == nomorown ? 'Developer' : (usrs.premiumTime >= 1 ? 'Premium User' : 'Free User')}
┃${z} *Premium* : ${usrs.premiumTime > 1 ? '✔ Ya': '✘ Tidak'}
┃${z} *Role* : ${usrs.role}
┃${z} *Limit* : ${usrs.limit}
┃${z} *Level* : ${usrs.limit}
┃${z} *Money* : ${money}
...
let res = "It's early morning Why haven't you slept yet?"
if (time >= 4) {
res = "Good Morning 🌄"
}
if (time >= 10) {
